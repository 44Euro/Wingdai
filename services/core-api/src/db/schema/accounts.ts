...
/** เอกสารและข้อมูลไรเดอร์ที่แอดมินต้องใช้อนุมัติ (product-spec §7) */
export const riderProfiles = pgTable(
  'rider_profiles',
  {
    ...
    // รับเงิน ชื่อบัญชีควรตรงกับชื่อตามกฎหมาย เป็นด่านกันบัญชีม้า (product-spec §7)
...
export const riderDocuments = pgTable(
  'rider_documents',
  {
    ...
    /** เหตุผลที่แอดมินไม่รับเอกสารใบนี้ null = ยังไม่ถูกปฏิเสธ */
    rejectionReason: text('rejection_reason'),
