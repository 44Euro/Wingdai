 ...
 *
 * แยกออกมาเพราะนี่คือส่วนที่พลาดแล้วเจ็บ: หลวมไปกลายเป็นช่องให้คนใช้ระบบเรา
 * ไล่ส่ง SMS ใส่เบอร์คนอื่น (แต่ละข้อความเราเป็นคนจ่าย) แน่นไปคนสมัครจริงก็สมัครไม่ได้
 * ทดสอบทุกขอบเขตได้โดยไม่ต้องต่อฐานและไม่ต้องรอเวลาจริง
 */
 ...
 * `prev` เป็น null แปลว่าเบอร์นี้ยังไม่เคยขอ
 */
