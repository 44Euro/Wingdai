...
describe('เปิดช่องทางจ่ายเงินที่ยังไม่รู้ค่าธรรมเนียม', () => {
  ...
  /**
   * คนอ่านคือซูเปอร์แอดมินที่เพิ่งกดสวิตช์ ข้อความต้องบอกว่าติดอะไรและใครแก้ได้
   * อัตราตั้งได้ที่เดียวคือในโค้ด ไม่ใช่จอ SA6 บอกชื่อค่าคงที่ไปก็ไม่ช่วยให้เขาทำอะไรได้
   */
  it('ข้อความบอกว่าติดที่อัตรา และต้องตั้งในระบบก่อน', () => {
    expect(() => assertFeeRateKnown('card_payment')).toThrow(/ต้องตั้งอัตราในระบบก่อน/);
  });
});
