 ...
 *
 * ทุกช่องทางเป็น 0 วันนี้เพราะยังไม่มีเกตเวย์ตาม §11.3 จึงยังไม่มีใครหักค่าธรรมเนียมจริง
 * ตัวอย่างใน §6.2 (ออเดอร์ ฿170 เสียค่าธรรมเนียม ฿1.36 = 80 bp) คือสภาพ **หลัง** เชื่อมเกตเวย์
 * ไม่ใช่สภาพตอนนี้ วันที่ §11.3 ได้คำตอบต้องกลับมาตั้งค่าที่นี่ — โดยเฉพาะ `card` ที่ §6.5
 * เตือนไว้ว่าห้ามปล่อยเป็นศูนย์เงียบ ๆ ไม่งั้นบัตรกลายเป็นต้นทุนที่มองไม่เห็น
 */
