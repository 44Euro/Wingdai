 ...
 * ของทิป ไม่ได้สนใจตัวประตู จึงเปิดตรง ๆ ผ่าน mock
 *
 * ฝั่งเซิร์ฟเวอร์เปิดแบบนี้ไม่ได้แล้ว — `setFlag` ปฏิเสธจนกว่าจะตั้งอัตราค่าธรรมเนียม
 * mock ไม่ทำตามด่านนั้นโดยตั้งใจ เพราะที่นี่ไม่มีบัญชีให้ด่านนั้นปกป้อง (เหตุผลเต็มอยู่ที่ `setFlag` ของ mock)
 */
