...
const order: Order = {
  ...
  status: 'delivered',
  items: [
    { menuItemId: 'm-1', name: 'ข้าวกะเพรา (ไข่ดาว)', unitPrice: 6500, quantity: 2 },
    { menuItemId: 'm-2', name: 'ชาไทยเย็น', unitPrice: 2500, quantity: 1 },
  ],
  foodTotal: 15500,
  deliveryFee: 1500,
  serviceFee: 500,
...
describe('ReceiptScreen (C14)', () => {
  ...
  /** claude.md §3 ข้อ 2 — ค่าอาหาร/ค่าส่ง/ค่าบริการ ต้องแยกบรรทัด ห้ามรวบเป็นก้อนเดียว */
   ...
   * ถ้าโผล่บนใบเสร็จจะดูเหมือนลูกค้าจ่ายเพิ่ม ซึ่งขัดกับคำสัญญา "ราคาเท่าหน้าร้าน"
   */
