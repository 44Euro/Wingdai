...
describe('WingdaiTabBar', () => {
  ...
  /** เคสจริงที่ผู้ใช้เจอ: สั่งอาหารสำเร็จแล้ว แต่ปุ่มกลางไม่โผล่ */
  it('สั่งอาหารจริงแล้วปุ่มกลางต้องโผล่ (ไม่ mock useActiveOrder)', async () => {
    jest.restoreAllMocks();
    await act(async () => {
    ...
    const result = render();
    // รอ useCustomerOrders ดึงข้อมูลเสร็จ
