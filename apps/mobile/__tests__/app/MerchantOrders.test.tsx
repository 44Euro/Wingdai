...
describe('MerchantOrdersScreen — คิวออร์เดอร์ของร้าน', () => {
  ...
  /**
   * ยอดที่โชว์ต้องเป็น "ร้านได้เท่าไหร่" = ค่าอาหาร − 15% (claude.md §6.1)
   * ข้าวกะเพรา ฿50 + ไข่ดาว ฿15 = ฿65 × 2 = ฿130 → หัก ฿19.50 → ร้านได้ ฿110.50
   * ถ้าเผลอโชว์ยอดที่ลูกค้าจ่าย (รวมค่าส่ง+ค่าบริการ) ร้านจะคาดหวังเงินผิดตั้งแต่ใบแรก
   */
  it('โชว์ยอดที่ร้านได้จริง ไม่ใช่ยอดที่ลูกค้าจ่าย', async () => {
    ...
    // ทั้งสองตัวต้องไม่โผล่ในจอของร้าน เพราะไม่ใช่เงินที่ร้านจะได้
