...
const SHAPES: Record<IconName, Shape> = {
  ...
  globe: { p: ['M2.5 12h19', 'M12 2.5a15 15 0 0 1 4 9.5 15 15 0 0 1-4 9.5 15 15 0 0 1-4-9.5 15 15 0 0 1 4-9.5Z'], c: [[12, 12, 9.5]] },
  moon: { p: ['M20.5 14.5A9 9 0 0 1 9.5 3.5a9 9 0 1 0 11 11Z'] },
  ...
  // ปุ่มออเดอร์กลาง navbar path ตรงกับที่ design ใช้ในจอ C1/C32
