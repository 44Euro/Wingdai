...
const job = (status: RiderJob['status']): RiderJob => ({
  ...
  items: [],
  prepTimeMinutes: 12,
  acceptedAt: '2026-08-04T05:00:00.000Z',
  riderPaySatang: 1500,
  collectCashSatang: 0, leaveAtDoor: false,
});

describe('จังหวะส่งพิกัดของไรเดอร์ (product-spec §5)', () => {
  ...
  it('ค่าที่ตั้งอยู่ในช่วงที่ product-spec §5 กำหนด', () => {
