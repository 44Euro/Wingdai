 ...
 *
 * ห้ามใส่ blur ที่จอนี้ (claude.md §10) — พื้นทึบล้วนเท่านั้น
 */
export function MerchantOrderDetailScreen({ navigation, route }: Props) {
  ...
  const run = (status: 'accepted' | 'preparing' | 'cancelled') =>
    ...
    >
      ...
      >
        {isNew ? (
           ...
           * หมดเวลาแล้วออร์เดอร์ **ไม่ถูกยกเลิกอัตโนมัติ** ดูเหตุผลใน acceptWindow.ts
           */
        ...
        {/*
          ...
          claude.md §6.1 — 15% คือฐานของคำสัญญา "ราคาเท่าหน้าร้าน" จึงต้องโปร่งใสกับร้าน
        */}
        <Card>
          <View style={{ gap: p.space.sm }}>
