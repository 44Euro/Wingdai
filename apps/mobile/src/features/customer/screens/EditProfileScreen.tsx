 ...
 * C21 — แก้โปรไฟล์
 *
 * แก้ได้แค่ **ชื่อ** กับ **อีเมล** ส่วนเบอร์กับชื่อผู้ใช้โชว์แบบอ่านอย่างเดียวพร้อมเหตุผล
 * ไม่ใช่ซ่อนหายไปเฉย ๆ — ผู้ใช้ที่อยากเปลี่ยนเบอร์ต้องรู้ว่าทำไมเปลี่ยนตรงนี้ไม่ได้
 * (เบอร์ผ่าน OTP มาแล้ว · username คือ identifier ที่ใช้ล็อกอิน — claude.md §4.2)
 */
