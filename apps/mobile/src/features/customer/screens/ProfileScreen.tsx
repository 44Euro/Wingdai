      ...
      >
        ...
        <View style={{ paddingHorizontal: p.space.screen, gap: p.space.lg }}>
          ...
          <Card padded={false} style={{ overflow: 'hidden' }}>
            ...
            {/* AD4 ทางเข้าตั๋วซัพพอร์ตแบบเปิดลอย ๆ อีกทางคือจากใบเสร็จซึ่งพก orderId มาให้ */}
            <Pressable
              testID="btn-support"
              accessibilityRole="button"
            ...
            >
              <IconChip name="help" tone="teal" size={36} />
              <View style={{ flex: 1, minWidth: 0 }}>
                <Text variant="small" bold>{t('support.title')}</Text>
                <Text variant="caption" color="muted" numberOfLines={1}>
            ...
            {/* C12 SY5 ภาษาและธีมเลือกเองได้ ไม่ใช่ตามอุปกรณ์อย่างเดียว */}
            <Pressable
              testID="btn-settings"
              accessibilityRole="button"
            ...
            >
              <IconChip name="globe" tone="teal" size={36} />
              <View style={{ flex: 1, minWidth: 0 }}>
                <Text variant="small" bold>{t('settings.title')}</Text>
                <Text variant="caption" color="muted" numberOfLines={1}>
