...
/**
 * ลูกค้าแจ้งปัญหาออร์เดอร์ (claude.md §6.4)
 *
 * **จอนี้ไม่สัญญาว่าจะได้เงินคืน** และไม่โชว์ยอดที่ระบบเสนอด้วย เพราะคนที่ตัดสินคือแอดมิน
 * โชว์ยอดตั้งแต่ตอนแจ้งจะกลายเป็นคำสัญญาที่เราอาจผิดคำ ซึ่งแย่กว่าไม่บอกเลย
 */
