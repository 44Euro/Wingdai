...
export function createMockRepos(): Repos {
  ...
  return {
    ...
    super: {
      ...
      /**
       * ต่างจากเซิร์ฟเวอร์โดยตั้งใจ: ของจริงไม่ยอมให้เปิด `card_payment` จนกว่าจะตั้งอัตรา
       * ค่าธรรมเนียม (§6.2) ด่านนั้นปกป้องบัญชี ไม่ให้บัตรลงรายการโดยไม่มีบรรทัดค่าธรรมเนียม
       * โหมดนี้ไม่มีบัญชีให้ปกป้อง ทิปที่นี่บวกเข้าตัวเลขบนจอ ไม่ใช่ยอดค้างจ่ายที่ใครต้องจ่ายจริง
       * จึงเปิดได้ เพื่อให้เดโมเดินให้ดูได้ว่าวันที่เกตเวย์พร้อมหน้าตาเป็นยังไง
       */
