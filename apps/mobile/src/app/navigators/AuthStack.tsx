...
import { repos, getDataMode } from '../../data';
...
export function LoginScreen({ navigation }: Props) {
  ...
  async function handleGoogle() {
    ...
    try {
      ...
      /** คนใหม่ยังเข้าแอปไม่ได้ทันที Google ไม่ทดแทน OTP (product-spec §4.2) */
      ...
      >
        ...
        >
          ...
          <View style={{ gap: p.space.md }}>
            ...
            {/* ลิงก์สาธิตไม่มีทางให้ใครสมัครแล้วเห็นฝั่งร้าน ไรเดอร์ หรือแอดมิน จึงต้องบอกบัญชีไว้ */}
            <DemoAccounts
              mode={getDataMode()}
              onPick={(username, pw) => {
